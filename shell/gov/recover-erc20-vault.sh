...
TO=0x182a31A27A0D39d735b31e80534CFE1fCd92c38f
...
forge script script/gov/InfraredMultisigGovernance.s.sol:InfraredMultisigGovernance \
    --sig "recoverERC20FromVault(address,address,address,address,address,uint256)" $SAFE $INFRARED $STAKING_ASSET $TO $TOKEN $AMOUNT  \
    --rpc-url $RPC_URL \
