...
DEPLOY_OUTPUT=$(forge script script/upgrades/infrared/v1.5/DeployInfraredV1_5.s.sol:DeployInfraredV1_5  --broadcast  --rpc-url $RPC_URL  --private-key $PRIVATE_KEY -vvvv 2>&1)
