...
contract InfraredBERAV2_1 is ERC20Upgradeable, Upgradeable, IInfraredBERAV2 {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*                       STORAGE                              */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    ...
    function registerViaProofs(
        ...
        // reset exit flag if validator has balance on CL
        if (_exited[_pubkeyHash] && _balance > 0) {
            _exited[_pubkeyHash] = false;
        }
