...
import {IBribeCollectorV1_4} from
    "src/interfaces/upgrades/IBribeCollectorV1_4.sol";

/**
 * @title BribeCollector v1.4
 ...
 * @dev v1.4 adds a payout token setter and initializes payout token as iBGT
 */
contract BribeCollectorV1_4 is InfraredUpgradeable, IBribeCollectorV1_4 {
    ...
    /// @param _newPayoutToken updated payout token
    ...
    /// @inheritdoc IBribeCollectorV1_4
