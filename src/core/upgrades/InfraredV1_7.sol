...
import {
    ConfigTypes,
    IInfraredV1_7
} from "src/interfaces/upgrades/IInfraredV1_7.sol";
...
/// @custom:oz-upgrades-from src/core/upgrades/InfraredV1_5.sol:InfraredV1_5
contract InfraredV1_7 is InfraredUpgradeable, IInfraredV1_7 {
    ...
    function initializeV1_7(address _harvestBaseCollector)
        external
        onlyGovernor
    {
        if (_harvestBaseCollector == address(0)) revert Errors.ZeroAddress();
        auctionBase = true;
        harvestBaseCollector = _harvestBaseCollector;
    }
