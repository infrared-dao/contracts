...
interface IBribeCollectorV1_4 is IPOLErrors {
    /**
    ...
    /**
     * @notice Emitted when the payout token is updated by the governor
     * @param oldPayoutToken Previous payout token
     * @param newPayoutToken New payout token set
     */
