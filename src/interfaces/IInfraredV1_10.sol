...
interface IInfraredV1_10 {
     ...
     * @param _weight uint256 The weight value
     */
    function updateIRBribeSplit(uint256 _weight) external;
     ...
     */
    event ProtocolFees(address indexed _token, uint256 _amt, uint256);
     ...
     * @param _amtSIR The amount of collected bribe sent to the IR vault.
     */
    ...
    /**
     * @notice Emitted when the iBGT token is redeemed for bera.
     * @param sender The address that initiated the update.
    ...
    /**
     * @notice Emitted when toggleAuctionBase is called by keeper
     * @param _auctionBase new value of bool auctionBase
     */
