...
/// @notice Upgrades the CuttingBoardManager proxy to V1_1 via Safe multisig.
/// @dev    Batches upgradeToAndCall into the Safe transaction queue so the
///         multisig UI can review and confirm.
///         No re-initialisation is required — V1_1 adds new functions only.
contract UpgradeCuttingBoardManagerV1_1 is BatchScript {
